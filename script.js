...
const scenarios = {
 ...
 inventory: [
  ['Database','SOURCE','Inventory starts with data.','The database holds the inventory information used by the connected business systems.','SOURCE','Puppy inventory database'],
